...
class DashboardCRUD:
    ...
    def filter_recipes(self, db: Session, est_time_min: Optional[int] = None, est_time_max: Optional[int] = None,  
                   est_cost_min: Optional[float] = None, est_cost_max: Optional[float] = None):
