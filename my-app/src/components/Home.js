...
//   // 定义预设选项数组
//   const predefinedTastes = ["Sweet", "Spicy", "Sour"];
//   const predefinedMethods = ["Grill", "Boil", "Fry"];
//   const predefinedMeals = ["Breakfast", "Lunch", "Dinner"];
...
//                     className={`btn btn-outline-warning taste ${
//                       t === "Custom"
//                         ? taste.some((item) => !predefinedTastes.includes(item)) ? "active" : ""
//                         : taste.includes(t) ? "active" : ""
//                     }`}
//                     onClick={() => handleKeywordClick("taste", t)}
//                   >
...
//                     className={`btn btn-outline-warning method ${
//                       m === "Custom"
//                         ? cookingMethod.some((item) => !predefinedMethods.includes(item)) ? "active" : ""
//                         : cookingMethod.includes(m) ? "active" : ""
//                     }`}
//                     onClick={() => handleKeywordClick("cookingMethod", m)}
//                   >
...
//                     className={`btn btn-outline-warning time ${
//                       meal === "Custom"
//                         ? mealTime.some((item) => !predefinedMeals.includes(item)) ? "active" : ""
//                         : mealTime.includes(meal) ? "active" : ""
//                     }`}
//                     onClick={() => handleKeywordClick("mealTime", meal)}
//                   >
